...
<table>
  <tr>
    <!-- NAYAL TEX -->
    <td align="center" style="padding:0 10px 10px 10px; border:1px solid #444; border-radius:10px; width:220px; vertical-align:top; background-color:#061A40;">
      <img src="https://img.shields.io/badge/NAYAL%20TEX-Textile%20Management-061A40?style=flat-square&color=061A40&logoColor=white"
           style="width:100%; height:30px; object-fit:cover; display:block; margin:0; padding:0;" />
      ...
      <sub style="margin:0; padding:0; display:block; color:#ddd;">Textile management system with inventory tracking & dashboards.</sub><br>
      <a href="#" style="margin-top:auto; display:block; text-decoration:none; color:#61DAFB;">🔗 Live Demo</a>
    </td>
    <!-- Palm Mirage -->
